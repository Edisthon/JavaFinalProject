...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void btnRequestOtpActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (username.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter your username to request OTP.", "Username Required", JOptionPane.WARNING_MESSAGE);
            return;
        }
        try {
            UserInterface userService = RmiClientUtil.getUserService();
            String result = userService.requestOtp(username); 
            JOptionPane.showMessageDialog(this, result, "OTP Request Status", JOptionPane.INFORMATION_MESSAGE);
            if (result != null && (result.toLowerCase().contains("otp generated") || result.toLowerCase().contains("success") || result.toLowerCase().contains("otp sent"))) { 
                if(otpLabel != null) otpLabel.setVisible(true);
                if(txtOtp != null) {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) { 
        ...
        if (username.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Username is required.", "Login Error", JOptionPane.WARNING_MESSAGE);
            return;
        }
