...
public class AdminDashboard extends javax.swing.JFrame {
    ...
    setLocationRelativeTo(null); // center the window
     ...
     private void handleSelection() {
        ...
        switch (selected) {
            case "Register User":
                new RegisterUserForm(currentUser).setVisible(true);
                dispose();
                break;
            case "View Users":
                new ViewUsersForm(currentUser).setVisible(true);
                dispose();
                break;
            case "Update User":
                new UpdateUserForm(currentUser).setVisible(true);
                dispose();
                break;
            case "Delete User":
                new DeleteUserForm(currentUser).setVisible(true);
                dispose();
                break;
